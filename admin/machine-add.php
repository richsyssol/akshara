    ...
    <div class='dashboard-content'>
        ...
        <!-- page title -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="event">machine</a></li>
                <li class="breadcrumb-item"><a>Add machine</a></li>
            </ol>
            </nav>
            <!-- form -->
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Enter machine Name" required>
                </div>
