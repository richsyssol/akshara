...
<div class='dashboard-app'>
    ...
    <i class="fa-solid fa-trash"></i>&nbsp;&nbsp;Delete
                                            ...
                                            <a href="blog-edit.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><i class="fa-solid fa-pen-to-square"></i>&nbsp;&nbsp;Edit</a>
                                            <a href="blog-title.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Title</a>
                                            <a href="blog-sub-title.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Sub-Title</a>
                                            <a href="blog-faq?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;Add FAQ</a>
                                        </div>
                                    </div>
...
$(document).ready(function(){
    ...
    $('.deleteBtn').on('click', function(){
        ...
        console.log(deleteId);  // Check if deleteId is correctly set
        $('#deleteModal').modal('show');
    });

    // When confirm delete button in the modal is clicked
    $('#confirmDelete').on('click', function(){
        window.location.href = 'blog-delete.php?id=' + deleteId;
    });
});
</script>
