...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="product-add" class="btn btn-primary">Add Industries</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">About Industries</th>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="product-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'product-delete.php?id=' + deleteId;
    });
});
</script>
