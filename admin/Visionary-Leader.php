...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class='container-fluid'>
            <h1>visionaryl_leaders</h1>
        </div>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">visionaryl_leaders</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="Visionary-Leader-add.php" class="btn btn-primary">Add visionaryl_leaders</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--<a href="Visionary-Leader-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>-->
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'Visionary-Leader-delete.php?id=' + deleteId;
    });
});
</script>
