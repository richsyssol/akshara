...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `machine` SET `image`='$upload_file', `name`='$name' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);

            if($result){
                 // Use JavaScript to redirect
                echo '<script>window.location.href = "machine";</script>';
                exit();
            } else {
            ...
            // Insert new record
            $sql = "INSERT INTO `machine`(`id`, `image`, `name`) VALUES (NULL, '$upload_file', '$name')";
            $result = mysqli_query($conn, $sql);
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> Machine Banner </h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="event"> Machine Banner</a></li>
            ...
            <div class="container pt-5 w-50">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Machine Image</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Machine Title</label>
