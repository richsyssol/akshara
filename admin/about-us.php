...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `about_us`(`id`, `image`, `text`) VALUES ('NULL','$image','$text')";
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="about-us-add" class="btn btn-primary">Add About</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="about-us-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'about-us-delete.php?id=' + deleteId;
    });
});
</script>
