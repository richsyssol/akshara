...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `banner` SET `image`='$upload_file', `url`='$url', `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
            ...
            // Insert new record
            $sql = "INSERT INTO `banner`(`id`, `image`, `url`, `status`) VALUES (NULL, '$upload_file', '$url', '$status')";
            $result = mysqli_query($conn, $sql);
            ...
            <div class="container pt-5 w-50">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="url" class="form-control" id="exampleFormControlInput1" placeholder="abc.com" value="<?php echo $url; ?>" required>
                    </div>
                    <div class="mb-3">
