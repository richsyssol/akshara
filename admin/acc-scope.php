...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class='container-fluid'>
            <h1>ACCREDITATIONS SCOPE</h1>
        </div>
        <!-- breadcrumb -->
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">ACCREDITATIONS SCOPE</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="acc-scope-add" class="btn btn-primary">Add ACCREDITATIONS SCOPE</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'acc-scope-delete.php?id=' + deleteId;
    });
});
</script>
