...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="akshara-a-add" class="btn btn-primary">Add About</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="akshara-a-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'akshara-a-delete.php?id=' + deleteId;
    });
});
</script>
