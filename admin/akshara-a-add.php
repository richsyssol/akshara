...
if(isset($_POST['submit'])) {
    ...
    // Check if video file is uploaded correctly
    ...
    if ($image_uploaded && $video_uploaded) {
        $sql = "INSERT INTO `aksharaabout`(`id`, `image`, `video`, `text`) VALUES (NULL, '$image_path', '$video_path', '$text')";
...
<div class='dashboard-app'>
  ...
  <div class="mb-3">
     ...
     <input type="file" name="video" id="play-video" accept="video/*" required>
