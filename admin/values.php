...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="values-add.php" class="btn btn-primary">Add values</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    ...
                    include 'include/db_conn.php';
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <!--<a href="values.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-folder-plus"></i></a>&nbsp; / &nbsp;-->
                                    <a href="#" data-id="<?php echo $row['id']; ?>" class="deleteBtn"><i class="fa-solid fa-trash"></i></a> &nbsp; / &nbsp;
                                    <a href="values-edit.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'values-delete.php?id=' + deleteId;
    });
});
</script>
