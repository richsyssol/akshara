...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Quality policy</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="other_serv_add" class="btn btn-primary">Add Quality policy</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    $sql = "SELECT sub_other_ser.*, other_ser.ser_name 
                            FROM sub_other_ser 
                            JOIN other_ser ON sub_other_ser.service_id = other_ser.id";
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        $sub_service_id = $row['id'];
                                        $sql_images = "SELECT * FROM sub_otherser_service_images WHERE sub_service_id = '$sub_service_id'";
                                ...
                                <td>
                                    ...
                                    <a href="other-serv-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'other-serv-delete.php?id=' + deleteId;
    });
});
</script>
