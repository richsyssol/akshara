...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="career-add" class="btn btn-primary">Add Career</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="career-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'career-delete.php?id=' + deleteId;
    });
});
</script>
