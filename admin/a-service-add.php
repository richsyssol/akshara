...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($image_tmp, $upload_file)) {
            ...
            $sql = "INSERT INTO `serv`(`id`, `image`, `name`) VALUES (NULL, '$upload_file', '$name')";
            $result = mysqli_query($conn, $sql);
            
            if($result){
                // Use JavaScript to redirect
                echo '<script>window.location.href = "a-service";</script>';
                exit();
    ...
    <div class='dashboard-content'>
        ...
        <!-- page title -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="a-service">Service</a></li>
                <li class="breadcrumb-item"><a>Add Service</a></li>
            </ol>
            </nav>
            <!-- form -->
