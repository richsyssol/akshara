...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `aksharaeng`(`id`, `image`,`video`, `text`) VALUES ('NULL','$image', 'video','$text')";
        
        $result = mysqli_query($conn , $sql);
        
        if($result){
            header("Location: aksharaeng");
            exit;
        }
        else{
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="akshara-engineers-add" class="btn btn-primary">Add About</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="akshara-engineers-edit?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php 
                        }
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'akshara-engineers-delete.php?id=' + deleteId;
    });
});
</script>
