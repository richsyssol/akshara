...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE `certification` SET `name` = '$name', `image` = '$imagePath' WHERE `id` = $visionaryl_leadersId";
    if (mysqli_query($conn, $updateSql)) {
        header("Location: certification.php?msg=Event updated successfully");
        exit();
    } else {
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> certification</h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $id ? "Edit" : "Add"; ?> certification</li>
                </ol>
            </nav>
            <!-- form -->
