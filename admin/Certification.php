...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="Certification-add.php" class="btn btn-primary">Add certification</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">certification Image</th>
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'Certification-delete.php?id=' + deleteId;
    });
});
</script>
