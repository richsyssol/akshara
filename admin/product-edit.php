...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if ($id) {
            ...
            $sql = "UPDATE `product` SET `image`='$upload_file', `p_name`='$p_name', `price`='$price',`about`='$about', `status`='$status' WHERE `id`=$id";
            $result = mysqli_query($conn, $sql);
...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        <div class='container-fluid'>
            <!-- page title -->
            <div class='container-fluid'>
                <h1><?php echo $id ? "Edit" : "Add"; ?> Industries</h1>
            </div>
            <!-- breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><?php echo $id ? "Edit" : "Add"; ?> Industries</li>
                </ol>
            </nav>
            <!-- form -->
            <div class="container pt-5 w-50">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="p_name" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $p_name; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Industries Price</label>
                        <input type="text" name="price" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $price; ?>" required>
                    </div>
                    <div class="mb-3">
                      <label for="exampleFormControlTextarea1" class="form-label">Message</label>
                      <textarea class="form-control" name="about" id="exampleFormControlTextarea1" rows="3"><?php echo htmlspecialchars($about); ?></textarea>
                    </div>
                    <div class="mb-3">
