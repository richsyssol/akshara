...
<div class='dashboard-app'>
    <div class='dashboard-content'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a>Blog Sub-Title</a></li>
        </ol>
        </nav>
        ...
        <div class="pt-5">
        <!-- Add Button -->
        <a href="blog-sub-title-add.php" class="btn btn-primary">Add Blog Sub-Title</a>
        </div>
        <!-- table -->
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Sub-Title Description</th>
                ...
                <tbody>
                    ...
                    include 'include/db_conn.php';
                        ...
                        $sql = "SELECT blog_sub_titles.*, blog_titles.b_title 
                                FROM blog_sub_titles 
                                JOIN blog_titles ON blog_sub_titles.b_title_id   = blog_titles.id";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $description_words = explode(" ", $row['s_description']);
                                ...
                                <td>
                                    <div class='dashboard-nav-dropdown'>
                                        ...
                                        <div class='dashboard-nav-dropdown-menu'>
                                            ...
                                            <a href="blog-sub-title-edit.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark"><i class="fa-solid fa-pen-to-square"></i>&nbsp;&nbsp;Edit</a>
                                        </div>
                                    </div>
...
$(document).ready(function(){
    ...
    $('#confirmDelete').on('click', function(){
        window.location.href = 'blog-sub-title-delete.php?id=' + deleteId;
    });
});
</script>
